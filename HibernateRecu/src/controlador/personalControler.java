   ...
   public  void insertarPersonal(Personal c) {
    ...
    public static void eliminarPersonal(Personal r){
       ...
       Configuration cfg = new Configuration();
        ...
        Session session = null;
        session = factory.openSession();
        List<Personal> p = session.createQuery("FROM Personal WHERE id_personal='"+r.getIdPersonal()+"'").list();
        Personal aux = p.get(0);
        aux.setIdPersonal(r.getIdPersonal());
