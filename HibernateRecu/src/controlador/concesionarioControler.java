...
import hibernaterecu.Concesionario;
 ...
 public  void concesionarioControler(Concesionario c) {
    ...
    public static void eliminarConcesionario(Concesionario r){
       ...
       Configuration cfg = new Configuration();
        ...
        Session session = null;
        session = factory.openSession();
        List<Concesionario> p = session.createQuery("FROM Concesionario WHERE id_concesionario='"+r.getIdConcesionario()+"'").list();
        Concesionario aux = p.get(0);
        aux.setIdConcesionario(r.getIdConcesionario());
